    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-xs text-gray-400 mt-2">
          ⚠️ In rare cases (two guests booking the last room at the exact same moment), a payment may
          succeed but the room may already be taken. If a guest reports being charged without a
          confirmed reservation, please refund manually via the payment gateway.
        </p>
      </div>
